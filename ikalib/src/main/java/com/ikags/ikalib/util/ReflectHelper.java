...
public class ReflectHelper {
	...
	try {
	    ...
	    IKALog.e(TAG, "ClassNotFoundException reason="+e.getMessage());
	}
	return null;
    }
    /**
	...
	try {
	    ...
	    IKALog.e(TAG, "NoSuchFieldException reason=" + ex.getMessage());
	} catch (Exception ex) {
	    IKALog.e(TAG, "Exception reason=" + ex.getMessage());
	}
	return retValue;
    }
