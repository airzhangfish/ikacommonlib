...
public class UploadUtil {
	 ...
	 * @return 返回响应的内容
	 */
	public static String uploadFile(String facepic,File file, String RequestURL) {
		int res = 0;
		String result = null;
		...
		try {
			...
			if (file != null) {
				...
				sb.append("Content-Disposition: form-data; name=\""+facepic+"\"; filename=\"" + file.getName() + "\"" + LINE_END);
